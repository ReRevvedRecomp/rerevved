...
- The main-menu logo is a title-internal asset selection. At startup the title
  asks the SDK resolver for `file-data/GFX_MainMenu_logo.dds`, validates the
  selected package payload as the supported legacy 1024x256 A8R8G8B8 DDS, and
  applies it at the type-11 opener. There is no public asset-file override ABI
  or general asset replacement API.
